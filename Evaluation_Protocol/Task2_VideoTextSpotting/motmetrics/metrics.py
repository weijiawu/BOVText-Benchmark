...
def rec_tp(df):
    """Total number matches."""
    return df.noraw.Rec.isin(['tp']).sum()
simple_add_func.append(rec_tp)

def rec_fp(df):
    """Total number matches."""
    return df.noraw.Rec.isin(['fp']).sum()
simple_add_func.append(rec_fp)

def rec_fn(df):
    """Total number matches."""
    return df.noraw.Rec.isin(['fn']).sum()
simple_add_func.append(rec_fn)
...
# def recall_s(df, rec_tp, num_objects):
#     """Number of detections over number of objects."""
#     del df  # unused
#     return math_util.quiet_divide(rec_tp, num_objects)

# def precision_s(df, rec_tp, rec_fp):
#     """Number of detected objects over sum of detected and false positives."""
#     del df  # unused
#     return math_util.quiet_divide(
#         rec_tp,
...
# def f_score(recall_s, precision_s):
#     return 0

# simple_add_func.append(recall_s)
# simple_add_func.append(precision_s)
# simple_add_func.append(f_score)
...
#     m.register(recall_s, formatter='{:.1%}'.format)
